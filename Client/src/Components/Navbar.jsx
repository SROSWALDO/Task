...
export default function Navbar({ handleCreate, handleChangeTheme }) {
  return (
    <div className="flex justify-around bg-white h-14 items-center shadow-md relative dark:bg-[#242424] dark:text-white dark:shadow-gray-700 dark:shadow ">
      <div className="logo">Todo App</div>
      <div className="buttons flex items-center ">
        
        <button className="absolute right-10">About me</button>
         
<label onClick={handleChangeTheme} class="switch">
